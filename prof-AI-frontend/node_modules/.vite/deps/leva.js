...
import {
  require_prop_types,
  useDrag
} from "./chunk-EY6ZKXOM.js";
import {
  require_react_dom
} from "./chunk-DSSU5RFN.js";
import {
  create
} from "./chunk-7B2IWIQY.js";
import {
  require_react
...
function createContextScope(scopeName, createContextScopeDeps = []) {
  ...
  function createContext32(rootComponentName, defaultContext) {
    ...
    const Provider = (props3) => {
      ...
      const Context3 = scope?.[scopeName]?.[index2] || BaseContext;
...
var PopperContent = React14.forwardRef(
  (props3, forwardedRef) => {
    ...
    const [arrow3, setArrow] = React14.useState(null);
...
function usePopin(margin = 3) {
  ...
  const hide2 = (0, import_react8.useCallback)(() => setShow(false), []);
  (0, import_react8.useLayoutEffect)(() => {
    if (shown) {
      const {
        bottom,
